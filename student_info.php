        ...
        <div class = "container-fluid">
            <h4 class="mb-4 fw-semibold">Student Information Management <br><br></h4>
                ...
                <?php if (isset($_GET['error'])): ?>
                    ...
                    $error_msg = $error_message[$_GET['error']] ?? 'Invalid input. Please try again.';
                    ?>
        ...
        <form action="student_info.php" method="POST">
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <input type="text" class="form-control" name="first_name" id="edit-first-name" pattern="^[A-Z][a-zA-Z]*(\s[a-zA-Z]+)*$" title="First letter must be capitalized, letters only" required>
            </div>
            <div class="col-md-6 mb-3">
            ...
            <div class="col-md-6 mb-3">
              <label class="form-label">Grade Level</label>
                <select class="form-control" name="grade_level" id="edit-grade" required>
      ...
      <div class="modal-body">
        ...
        <form action="student_info.php" method="POST">     
          <div class="mb-3">
            ...
            pattern="^[A-Z][a-zA-Z]*(\s[a-zA-Z]+)*$" title="First letter must be capitalized, letters only" required>
          </div>
